...
public class BookingService {
    ...
    public Booking createBooking(Booking b) {
        ...
        if (v.getDriverEmail() != null) {
            String msg = "New Booking: " + b.getSeats() + " seats. Offer: Rs." + b.getTotalPrice();
            // Use safe path (replace '.' with '_') or just use email directly if allowed
            messagingTemplate.convertAndSend("/topic/driver/" + v.getDriverEmail(), msg);
        }
